<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignUp.aspx.cs" Inherits="Khomenko_Is61.SignUp" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="center-page">
            ...
            <asp:Button ID="btSignup" runat="server" class="btn btn-success" Text="Sign Up" OnClick="btSignup_Click1" />
